/// Templates for the `<app>/jobs.gleam` module the `jobs` command writes.
///
import mastro/cli/templates/jobs_sql.{sql}
...
pub fn module_postgres(app: String) -> String {
...
pub fn module_sqlite(app: String) -> String {
